...
exports.snip_GLL = function (satid, instid, imageType, datetime, l_t_lat, l_t_lon, r_b_lat, r_b_lon, resolution, callback) {
    ...
    */
    ...
    var num03 = datetime;
    var num04 = null;
    if (instid.toUpperCase() == "MERSI" && resolution < 4000) {
        num04 = "0250";
        resolutionPath = "GLL";
    } else if (instid.toUpperCase() == "MERSI" && resolution >= 4000) {
        num04 = "4000";
        resolutionPath = "MOS";
    } else {
        num04 = "4000";
    ...
    itemList.forEach(function (item) {
        ...
        //TODO: 如果文件名中的GLL 在4KM分辨率时改成了MOS 则此处代码需要修改·
        var filename = "{0}_{1}_T{2}_L2_PAD_MLT_GLL_{3}_POAD_{4}M_MS_{5}.JPG".format(num00, num01, num02, num03, num04, num05);
        item.filename = BASEPATH + "{0}/{1}/{2}/{3}/".format(satid.toUpperCase(), instid.toUpperCase(), datetime, resolutionPath) + filename;
